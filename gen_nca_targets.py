...
from puzzlescript_jax.preprocessing import PS_LARK_GRAMMAR_PATH, PSErrors, get_env_from_ps_file
...
from validate_sols_jax import JS_SOLS_DIR, multihot_level_from_js_state, JAX_VALIDATED_JS_SOLS_DIR
...
def main(cfg: SearchNodeJSConfig):
    ...
    for game_dir in game_sols_dirs:
        ...
        for level_sol_json in level_sol_jsons:
            ...
            print(f"Level {level_i} solution rendered and saved to {level_sol_gif_path}")
