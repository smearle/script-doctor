...
from nca_wm.models import RecurrentNCAWorldModel
...
# ---------------------------------------------------------------------------
# Data loading + trajectory infra live in the jax-free nca_wm.recurrent_data
# module so torch-only consumers (the belief models) can import them without
# pulling in jax/optax/flax/puzzlescript_cpp. Re-exported here so existing
# `from nca_wm.train_recurrent import ...` call sites keep working unchanged.
# ---------------------------------------------------------------------------
from nca_wm.recurrent_data import (  # noqa: E402
    N_ACTIONS,
