...
\node[font=\scriptsize\bfseries, anchor=south] at (slots.north) {latents $z$};
...
\node[draw, rounded corners=2pt, line width=0.5pt, inner sep=2pt, anchor=east]
    (sin) at (0.7, 0) {\includegraphics[width=1.7cm]{state_in.png}};
...
\node[draw, rounded corners=2pt, line width=0.5pt, inner sep=2pt, anchor=west]
    (sout) at (10.4, 0) {\includegraphics[width=1.7cm]{state_out.png}};
