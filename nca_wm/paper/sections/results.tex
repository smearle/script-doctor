...
\begin{table}[t]
  \centering
  \caption{\textbf{Baselines vs.\ rule-conditioned NCA on
    \textsc{sokoban\_basic} (multi-grid synth).} Three seeds; widths
    $\{5{\times}5, 6{\times}6, 7{\times}7, 8{\times}8\}$ with 256
    levels per width. Memorization is unavailable; the model has to
    learn the rule.}
  ...
  \begin{tabular}{l c c c c c}
    ...
    Architecture & params (M) & best loss & BFS final-err & rand mean-err & A* first-div \\
    \midrule
    NCA (shared)  & TBD & TBD & TBD & TBD & TBD \\
    NCA (per-step) & TBD & TBD & TBD & TBD & TBD \\
