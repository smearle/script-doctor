...
three game collections: a curated Gallery, a larger Archive of scraped
community games, and gists. We use the same high-level collections
(our Gallery, \texttt{scraped\_games}, and
\texttt{scraped\_games\_increpare}, respectively) but extend the
tooling with a C++ engine backend, cached transition datasets, and
rule-conditioned learned forward models.
