...
jointly model many games at once. At fixed capacity, per-game
in-distribution fidelity on shared games degrades as the corpus
widens (Appendix~\ref{app:dilution}), but rule-conditioning slows
that dilution by roughly an order of magnitude relative to an
unconditional model
(Table~\ref{tab:indist-dilution},
