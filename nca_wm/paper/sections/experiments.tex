...
\paragraph{Corpus.}
Our corpus is the union of four PuzzleScript collections: the official
PuzzleScript.net gallery, a community scrape of the same site, an
increpare-author scrape, and a small set of curated custom games.
...
games for a within-source scaling point),
