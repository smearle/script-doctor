...
\papertodo{Once the broad-corpus, autoencoder, and inverse-fitting
results are added, rewrite this paragraph as a positive synthesis.
Until then, keep this limitation explicit so the body does not imply
that all abstract claims have already been demonstrated.}
...
\papertodo{Reconcile this ceiling with the abstract's
``near-perfect fidelity'' claim. If near-perfect results are obtained
on the broad authored corpus but not synthetic multi-grid OOD tasks,
state that distinction explicitly and explain what type of
