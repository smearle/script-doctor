...
# Pure-numpy transition-graph helpers live in nca_wm.transition_graph so the
# torch-only belief models can use them without importing this module (which
# pulls in jax / puzzlescript_cpp / puzzlescript_jax). Re-exported here so
# existing `from nca_wm.data_collection import ...` call sites keep working.
from nca_wm.transition_graph import (  # noqa: F401
    build_predecessor_adjacency,
    sample_backward_paths,
    ancestor_closed_subsample,
)
